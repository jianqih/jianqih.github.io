---
title: 'Arrival of Young Talent'
description: "What is the potential outcome from the culture revolution in 1970s, especially the effect of send-down movement to local people."
date: '2022-07-11'
author: 'Jianqi Huang'
categories:
    - Econ
...
<img src="images/sum.jpg" alt="" style="zoom:40%;" />
...
<img src="images/baseline2.png" alt="" style="zoom:50%;" />

- $Y\_Edu_{i,g,c,p}$ 在 $p$ 省 $c$ 县 $g$ 组内个体i的受教育年限；$\%SDY_{c,p}$ 为知青（SDYs）在 $p$ 省 $c$ 县的人群密度；$\mathbf{X}_{i,h,c,p}$ 为个体层面控制向量，包括性别，种族等；$\lambda_c$为县的个体固定效应；$ u_{g,p}$为省的群体固定效应；$\gamma_c\times\mu_g$ 为在知青到来之前的虚拟变量。

**县的基础教育通过处等教育和高中毕业率来计算**
<img src="images/baseline.png" alt="" style="zoom:50%;" />
...
<img src="images/SDY_effect.jpg" alt="" style="zoom:50%;" />



根据建立计量模型所回归得到的$ \beta_{1,\gamma}$系数显示：效应显著立即上升当知青到来；随着运动的结束，效应开始下降；

<img src="images/dep_var.png" alt="" style="zoom:50%;" />
